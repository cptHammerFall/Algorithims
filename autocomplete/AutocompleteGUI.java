...
public class AutocompleteGUI extends JFrame {
    ...
    private class AutocompletePanel extends JPanel {
        ...
        public void getSuggestions(String text) {
            ...
            if (text.equals("")) {
                ...
                Term[] allResults = auto.allTerms(text);
                if (allResults == null) {
    ...
    public static void main(String[] args) {
        final String filename = "/Users/TALONted/Desktop/SLCC_School/2017-Fall/Data&Algorithims/Autocomplete/src/autocomplete/wiktionary.txt";
        final int k = 15;
